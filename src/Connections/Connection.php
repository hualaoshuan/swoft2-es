...
use Hualaoshuan\Elasticsearch\Client;
use Hualaoshuan\Elasticsearch\Common\Exceptions\AlreadyExpiredException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\BadRequest400Exception;
use Hualaoshuan\Elasticsearch\Common\Exceptions\Conflict409Exception;
use Hualaoshuan\Elasticsearch\Common\Exceptions\Curl\CouldNotConnectToHost;
use Hualaoshuan\Elasticsearch\Common\Exceptions\Curl\CouldNotResolveHostException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\Curl\OperationTimeoutException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\Forbidden403Exception;
use Hualaoshuan\Elasticsearch\Common\Exceptions\MaxRetriesException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\Missing404Exception;
use Hualaoshuan\Elasticsearch\Common\Exceptions\NoDocumentsToGetException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\NoShardAvailableException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\RequestTimeout408Exception;
use Hualaoshuan\Elasticsearch\Common\Exceptions\RoutingMissingException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\ScriptLangNotSupportedException;
use Hualaoshuan\Elasticsearch\Common\Exceptions\ServerErrorResponseException;
